...
<div  align="center">    
 <img src="https://i.postimg.cc/ncB9NQ99/compress-video.png " width = "1000" height = "600" alt="Compressed Video" align=center />
</div>
...
<div  align="center">    
 <img src="https://i.postimg.cc/pVZKdjLN/dvr.png " width = "1000" height = "600" alt="DVR" align=center />
</div>

有以下几点启发:

(1) 针对这种压缩数据流设计高效视频检测跟踪网络，由于数据量减小，信息量不变。因此可以把batch做得很大，理论上更加高效。

(2) 反过来，在做视频超分和视频生成的时候可以生成有压缩的视频，再进一步还原。
